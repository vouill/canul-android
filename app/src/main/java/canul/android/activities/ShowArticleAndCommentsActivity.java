 ...
 */
public class ShowArticleAndCommentsActivity extends Activity implements EndlessScrollInterface, TaskInterface, View.OnClickListener {

    private static final String TAG = ShowArticleAndCommentsActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArticleAdapter(this, article, comments);
